...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-brand/10 to-brand/20 py-16">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="bg-brand p-3 rounded-lg">
                  <Mail className="h-6 w-6 text-dark-chocolate" />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-brand p-3 rounded-lg">
                  <Phone className="h-6 w-6 text-dark-chocolate" />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-brand p-3 rounded-lg">
                  <MapPin className="h-6 w-6 text-dark-chocolate" />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-brand p-3 rounded-lg">
                  <Clock className="h-6 w-6 text-dark-chocolate" />
                </div>
                <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={6}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand focus:border-transparent outline-none resize-none"
